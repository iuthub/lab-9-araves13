...
trait ResetsPasswords
{
    ...
    public function reset(Request $request)
    {
        ...
        return $response == Password::PASSWORD_RESET ? $this->sendResetResponse($response) : $this->sendResetFailedResponse($response);
    }
    protected function credentials(Request $request)
    {
...
trait AuthorizesRequests
{
    ...
    {
        return ['index' => 'view', 'show' => 'view', 'create' => 'create', 'store' => 'create', 'edit' => 'update', 'update' => 'update', 'destroy' => 'delete'];
    }
}
}
...
class Factory implements FactoryContract
{
    ...
    public function addLoop($data)
    {
        ...
        $this->loopsStack[] = ['index' => 0, 'remaining' => isset($length) ? $length : null, 'count' => $length, 'first' => true, 'last' => isset($length) ? $length == 1 : null, 'depth' => count($this->loopsStack) + 1, 'parent' => $parent ? (object) $parent : null];
    }
